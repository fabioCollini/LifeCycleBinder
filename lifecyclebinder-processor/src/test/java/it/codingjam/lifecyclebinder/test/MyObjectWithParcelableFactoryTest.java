...
public class MyObjectWithParcelableFactoryTest {
    ...
    public void testMyActivity() throws Exception {
        JavaFileObject expectedSource = FileLoader.loadClass("com.test.MyActivity2$LifeCycleBinder");
        JavaFileObject target = FileLoader.loadClass("com.test.MyActivity2");
