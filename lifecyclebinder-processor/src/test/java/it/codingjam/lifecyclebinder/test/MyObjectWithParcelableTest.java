...
public class MyObjectWithParcelableTest {
    ...
    public void testMyActivity() throws Exception {
        JavaFileObject expectedSource = FileLoader.loadClass("com.test.ActivityMyObjectWithParcelable$LifeCycleBinder");
        JavaFileObject target = FileLoader.loadClass("com.test.ActivityMyObjectWithParcelable");
