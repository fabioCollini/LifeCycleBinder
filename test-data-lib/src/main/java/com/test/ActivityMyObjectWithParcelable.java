...
class MyObjectWithParcelable2 implements ViewLifeCycleAware<MyView> {
...
public class ActivityMyObjectWithParcelable extends FragmentActivity implements MyView {
    @LifeCycleAware
    MyObjectWithParcelable2 myObject;
}